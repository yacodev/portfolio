  ...
  return (
    <section id='blog'>
      <div className='container'>
        ...
        <p className='mb-0'>
          Uno de mis pasatiempos preferidos es leer, me encanta los temas
          relacionados a las Startups. En las entradas de este blog encontrarás
          algunos resumes de los libros, espero que te sean utiles😉. Tambien
          encontrarás algunos de los proyectos en los que colabore.
        </p>
